...
public class LoginServlet extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        session.setAttribute("username",useName_enter);
        String isloginchecked="";
        isloginchecked=request.getParameter("loginchecked");
        try {
        ...
        if (!vcode_enter.equalsIgnoreCase(vcode)) {
            ...
            if ("on".equals(isloginchecked)) {
                passwordcookie = new Cookie("password", user.getPassWord());
                usernamecookie=new Cookie("username",useName_enter);
